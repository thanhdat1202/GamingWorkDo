...
class GamingMonitor extends StatefulWidget {
  const GamingMonitor({super.key});

  @override
  State<GamingMonitor> createState() => _GamingMonitorState();
}

class _GamingMonitorState extends State<GamingMonitor> {
  ...
  Future<void> fetchProducts() async {
    try {
      final products = await ProductService.getProductsByIds([1, 2, 3, 4]);
      setState(() {
